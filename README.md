...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/green-voice-5cf7#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-voice-5cf7
```

A live public deployment of this template is available at [https://green-voice-5cf7.templates.workers.dev](https://green-voice-5cf7.templates.workers.dev)
